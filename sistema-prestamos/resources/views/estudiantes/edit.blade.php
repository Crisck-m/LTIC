                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="cedula" class="form-control @error('cedula') is-invalid @enderror" value="{{ old('cedula', $estudiante->cedula) }}" placeholder="Ej: 1712345678" maxlength="10" required>
                                </div>
                                @error('cedula')
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-bold">Rol en LTIC <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $estudiante->email) }}" required>
                                </div>
                                @error('email')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12" id="otraCarreraDiv" style="display: {{ !in_array(old('carrera', $estudiante->carrera), ['Ingeniería en Sistemas', 'Ingeniería Informática', 'Tecnologías de la Información']) ? 'block' : 'none' }};">
                                <label for="otra_carrera" class="form-label fw-bold">Especificar Carrera <span class="text-danger">*</span></label>
                                <input type="text" name="otra_carrera" id="otra_carrera" class="form-control @error('otra_carrera') is-invalid @enderror" value="{{ !in_array(old('carrera', $estudiante->carrera), ['Ingeniería en Sistemas', 'Ingeniería Informática', 'Tecnologías de la Información']) ? old('otra_carrera', $estudiante->carrera) : old('otra_carrera') }}" {{ !in_array(old('carrera', $estudiante->carrera), ['Ingeniería en Sistemas', 'Ingeniería Informática', 'Tecnologías de la Información']) ? 'required' : '' }}>
                                @error('otra_carrera')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="observaciones" rows="3" class="form-control">{{ old('observaciones', $estudiante->observaciones) }}</textarea>
                            </div>
                        </div>
