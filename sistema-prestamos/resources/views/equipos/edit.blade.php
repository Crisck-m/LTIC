                    ...
                    <form action="{{ route('equipos.update', $equipo) }}" method="POST">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="codigo_puce" class="form-control" value="{{ $equipo->codigo_puce }}" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="estado" class="form-select">
                                    ...
                                    <option value="baja" {{ $equipo->estado == 'baja' ? 'selected' : '' }}>🔴 De Baja</option>
                                    <option value="prestado" {{ $equipo->estado == 'prestado' ? 'selected' : '' }} disabled>🟡 Prestado (No editable)</option>
                                </select>
                            </div>

                            <div class="col-12">
                                <label class="form-label fw-bold">Características</label>
                                <textarea name="caracteristicas" rows="3" class="form-control">{{ $equipo->caracteristicas }}</textarea>
                            </div>
                        </div>
