                ...
                <tbody>
                    @forelse ($pendientes as $prestamo)
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted small">{{ $prestamo->equipo->marca }} - {{ $prestamo->equipo->modelo }}</div>
                                        <span class="badge bg-secondary text-light">{{ $prestamo->equipo->codigo_puce }}</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="text-end">
                                <a href="{{ route('prestamos.finalizar', $prestamo) }}" class="btn btn-success text-white shadow-sm">
